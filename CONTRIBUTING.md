...
Another element that will help us go faster at solving the issue is to provide a reproducible test case. <!-- We often recommend to [use this CodeSandbox template](https://codesandbox.io/s/github/algolia/create-instantsearch-app/tree/templates/docsearch.js). TODO create this sandbox -->
