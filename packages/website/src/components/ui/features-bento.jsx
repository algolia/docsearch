        ...
        <div className="mt-10 grid grid-cols-1 gap-4 sm:mt-16 lg:grid-cols-6 lg:grid-rows-2">
          ...
          <div className="relative lg:col-span-3">
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] lg:rounded-tr-[calc(2rem+1px)]">
              ...
              <div className="p-10 pt-4">
                <p className="text-xl font-semibold font-display text-[var(--text)] my-4">AI-powered</p>
                <p className="mt-2 max-w-lg text-base text-[var(--text-secondary)]">
          ...
          <div className="relative lg:col-span-3">
            <div className="absolute inset-0 rounded-lg bg-[var(--surface)] lg:rounded-bl-4xl" />
            ...
            <div className="pointer-events-none absolute inset-0 rounded-lg outline outline-[var(--border)] lg:rounded-bl-4xl" />
          </div>

          <div className="relative lg:col-span-3">
            <div className="absolute inset-0 rounded-lg bg-[var(--surface)] max-lg:rounded-b-4xl lg:rounded-br-4xl" />
            ...
            <div className="pointer-events-none absolute inset-0 rounded-lg outline outline-[var(--border)] max-lg:rounded-b-4xl lg:rounded-br-4xl" />
          </div>
        </div>
      </div>
    </div>
