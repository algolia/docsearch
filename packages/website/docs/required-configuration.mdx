...
If your website is generated, thanks to one of [our supported tool][1], you do not need to change your website as it is already compliant with our requirements.
...
new Crawler({
  ...
  initialIndexSettings: {
    YOUR_INDEX_NAME: {
      // These attributes can be used as `facetFilters` in the frontend
      attributesForFaceting: ['type'],
      // Below are all the default settings of your Algolia index in order to
      // make DocSearch v3 work. Changing them can cause issue with the final
      // rendering
...
[1]: integrations
[2]: helpers.docsearch#recordProps-api-reference
...
[11]: templates
[12]: helpers.docsearch#complex-extractors
[13]: integrations
