...
This version has been rewritten in React, and now exposes React components. Vanilla JavaScript version is based on the React version with an alias to Preact.
...
Thanks to all the Alpha testers, and to [all the integrations][5] who already supports it!
...
[14]: helpers.docsearch#with-custom-variables
