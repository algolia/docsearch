...
> If you want to better understand the default parameters of the config below, you can take a look a the [Crawler configuration documentation](https://www.algolia.com/doc/tools/crawler/apis/configuration/).
