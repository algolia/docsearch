...
:::info
This guide is primarily for users of the Algolia Crawler, especially those with DocSearch-generated indices. If you are not using the Crawler or DocSearch, AskAI may yield even higher accuracy results. You can also manually create and upload a markdown index to use with AskAI.
