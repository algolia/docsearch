...
Crawls are scheduled at a random time once a week, you are also able to trigger new ones directly from [the Crawler interface][2]. You can also configure your schedule [from the config file](https://www.algolia.com/doc/tools/crawler/apis/configuration/schedule/)
