...
## We create the Crawler and your Algolia application

Once we receive [your application][1], we'll have a look at your website and create a custom [Algolia Crawler][5] and an Algolia application for it. The Crawler comes [a configuration file][6] which defines which URLs we should crawl or ignore, as well as the specific CSS selectors to use for selecting headers, subheaders, etc.
...
**With the Algolia application, comes an access to the dashboard for you to:**

- Browse your index and see how is your content indexed
