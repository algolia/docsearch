...
import { DocSearchHit, DocSearchHits } from 'docsearch-types';
...
const Results = ({ getItemProps, getMenuProps, hits }: ResultsProps) => {
  return (
    ...
    <footer className="algolia-docsearch-footer">
      <ul className="algolia-docsearch-commands">
        <li>
          <svg viewBox="0 0 16 16">
            ...
            <g fill="none" fillRule="evenodd">
              <rect
                ...
                stroke="currentColor"
                rx="2"
                className="algolia-docsearch-commands-border"
              />
          ...
          <span className="algolia-docsearch-commands-description">
            to select
          </span>
        </li>
      ...
      <div className="algolia-docsearch-logo">
        <a href="https://www.algolia.com/docsearch">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 168 24">
            <g fill="none">
              ...
              />
              <path
                className="algolia-docsearch-logo-brand-outer"
              ...
              />
              <path
                className="algolia-docsearch-logo-brand-inner"
