...
export function ActiveRefinements({ refinements, onRemove }: ActiveRefinementsProps): ReactNode {
          ...
          aria-label={translate(
            {
              ...
              description: 'The label for the button that removes an active filter',
            },
            { value },
          )}
